function [r, time, amplitude_response, phase_response, freq] = Function_Channel_Filter_as4(x, gain, noise_power, f_cutoff, fs)
...
y = filter(B, A, x);
noise = gaussian_noise(0, 30, size(y));  % var = 10, 20, 30
